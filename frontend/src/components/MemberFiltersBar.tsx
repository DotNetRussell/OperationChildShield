...
export function MemberFiltersBar() {
  ...
  return (
    <div className="mb-8 w-full min-w-0">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 max-w-[720px] mx-auto w-full min-w-0">
        <label className="flex flex-col gap-1 w-full min-w-0 sm:min-w-[10rem] sm:flex-1 sm:max-w-[14rem]">
          ...
          <select
            ...
            className="w-full max-w-full min-w-0 rounded-xl border-2 border-card-border bg-surface px-3 py-2.5 text-sm font-medium text-foreground outline-none focus:border-blue disabled:opacity-60 cursor-pointer"
          >
        ...
        <label className="flex flex-col gap-1 w-full min-w-0 sm:min-w-[10rem] sm:flex-1 sm:max-w-[16rem]">
        ...
        {hasFilters && (
          <div className="flex w-full sm:w-auto items-end">
            <button
              ...
              disabled={isPending}
              className="w-full sm:w-auto px-4 py-2.5 rounded-xl text-sm font-semibold text-blue border-2 border-blue/30 bg-blue/5 hover:bg-blue/10 disabled:opacity-60 transition-colors"
            >
              Clear filters
            </button>
          </div>
